...
fp1 = open('error.txt','w')
fp2 =  open('out3','w')  #open(argList[4],'w')  # outputfile containing the list of all friends
fp3 =  open('user2','r')   #open(argList[3],'r')  # input file containing the list of specified userIds 
APP_KEY =  '9JSITUF4FYOYrfNzx8HQ'      #argList[1]    # App Key or Consumer Key (API Key)
APP_SECRET = 'iFb1iGEFj1EhqiUdOZwXpWyljk4WpkcVrc7MVMW2nA'           #argList[2]   # App secret or Consumer Secret (API Secret)
